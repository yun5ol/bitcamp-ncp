...
class MyInterface4Impl implements MyInterface4 {
  ...
  public void m1() {
    ...
    // super.m2(); // 수퍼 클래스(object)를 m2()를 찾아올라간다.
    // MyInterface4.m2(); // m2()는 인스턴스(논스태틱) 메서드이기 때문에 인터페이스 이름으로 직접 호출 불가
    MyInterface4.super.m2(); // 앞에My가 빠지면 super는 Object를 의미하게 된다
...
public class Exam04 {
  ...
  public static void main(String[] args) {
    ...
    obj.m3(); // obj에 없으니깐 인터페이스의 디폴트 메서드로 찾아 올라가
    System.out.println("-----------------------------");
